...
import com.wms.manage.*;
import com.wms.role.Customer;
...
public class SuperAdministrator {
    public boolean create_prohibit_outbound(int goods_id, int customer_id) {     // 创建禁止出库货物
        ...
        try {
            ProhibitOutbound prohibitOutbound = new ProhibitOutbound(1, goods.getGoods_id(), goods.getGoods_name(),
                    goods.getSupplier_id(), Supplier.supplier_1.getSupplier_name(), customer_id,
            ...
            System.out.println("供应商名称:" + prohibitOutbound.getSupplier_name());
