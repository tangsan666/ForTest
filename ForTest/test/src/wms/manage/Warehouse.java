...
public class Warehouse {
    public static Warehouse warehouse_1 = new Warehouse(1, "1号仓库", "新疆",
            WarehouseKeeper.keeper_1.getKeeper_id(), WarehouseKeeper.keeper_1.getKeeper_name());
    public static Warehouse warehouse_2 = new Warehouse(2, "2号仓库", "甘肃",
            WarehouseKeeper.keeper_2.getKeeper_id(), WarehouseKeeper.keeper_2.getKeeper_name());
    public static Warehouse warehouse_3 = new Warehouse(3, "3号仓库", "西藏",
            WarehouseKeeper.keeper_3.getKeeper_id(), WarehouseKeeper.keeper_3.getKeeper_name());
